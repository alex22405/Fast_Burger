...
class PictureService
{
    ...
    {
        // On donne un nouveau nom à l'image (webp)
        ...
        // On colle la découpe qui vient de notre image source
        imagecopyresampled($resized_picture, $picture_source, 0, 0, $src_x, $scr_y, $width, $height, $squareSize, $squareSize);
